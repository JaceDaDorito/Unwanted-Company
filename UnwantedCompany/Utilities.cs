...
namespace UnwantedCompany
{
    ...
    {
        //CreateExplosion by Evaisa from LethalThings
        ...
        {
            UnwantedCompany.logger.LogDebug("Spawning explosion at pos: {explosionPosition}");
            ...
            for (int i = 0; i < array.Length; i++)
            {
                ...
                else if (array[i].gameObject.layer == 21)
                {
                    ...
                    {
                        UnwantedCompany.logger.LogDebug("Setting off other mine");
